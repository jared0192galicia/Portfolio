    ...
    <section className="border-l ml-4 mt-7">
      <Item>
        ...
        <p className="mt-2 text-sm text-gray-300">
          ...
          para permitir a los usuarios realizar transacciones de manera segura.
        </p>
      </Item>
      <Item>
        <div className="flex items-center">
      ...
      <Item>
        <div className="flex items-center">
          ...
          <span className="ml-2 text-sm text-gray-400">Correos dinamicos</span>
      ...
      <Item>
        <div className="flex items-center">
          ...
          <span className="ml-2 text-sm text-gray-400">Implementar XState</span>
      ...
      <Item>
        <div className="flex items-center">
          ...
          <span className="ml-2 text-sm text-gray-400">Punto de venta en </span>
          <FaJava className="ml-2 text-sky-600" size={24} />
        </div>
        <p className="mt-2 text-sm text-gray-300">
          Desarrollar un sistema POS usando Java Servlets y JSP <br />
          Base de datos gestionada solo con procedimientos almacenados de MySQL
        </p>
      </Item>
      <Item>
        <div className="flex items-center">
        ...
        <p className="mt-2 text-sm text-gray-300">
          Inicié y gestioné una estancia en Preslow, donde trabajé en proyectos
          y desarrollé habilidades en React, node y Express.
        </p>
      </Item>
      <Item>
        <div className="flex items-center">
